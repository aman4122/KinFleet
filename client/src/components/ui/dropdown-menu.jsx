...
const DropdownMenuSubTrigger = React.forwardRef(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      ...
      'focus:bg-primary/20 data-[state=open]:bg-primary/20 text-text-primary',
      inset && 'pl-8',
      className
    )}
    {...props}
...
const DropdownMenuSubContent = React.forwardRef(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      'z-50 min-w-[8rem] overflow-hidden rounded-xl glass-card p-1 shadow-2xl shadow-black/30 animate-scale-in',
      className
    )}
    {...props}
  />
...
const DropdownMenuItem = React.forwardRef(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ...
    className={cn(
      ...
      'focus:bg-primary/20 focus:text-text-primary text-text-primary',
